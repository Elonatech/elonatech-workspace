...
const Blog = () => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await axios.get('https://elonatech.onrender.com/api/v1/blog/');
                                ...
                                <div className="shadow mt-4">
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <h5 className='pb-3' style={{color:"#34548c"}}> <Link className='text-decoration-none' to={"/blog/74665573"}>{item.title}</Link></h5>

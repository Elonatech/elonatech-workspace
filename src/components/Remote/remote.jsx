  ...
  return (
   <section>
    <div className="remote-background">
            <div class="py-5 "  data-aos="fade-up" data-aos-duration="3000">
    ...
    <div className="container">
        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="col-md-6 pr-md-2" data-aos="fade-left" data-aos-duration="3000" >
        ...
        <div className="pt-5">
            <div class="row justify-content-center flex-column-reverse flex-lg-row" >
                <div class="col-md-6 gx-2" data-aos="fade-right" data-aos-duration="3000" >
            ...
            <div class="row  justify-content-center">
                ...
                <div class="col-md-3 mt-4" data-aos="zoom-out-left" data-aos-duration="3000">
                    <div class="card h-100 " style={{width:"18rem"}}>
